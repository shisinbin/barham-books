COLLECTIONS = {
  ...
  "historical-saga-war": {
    ...
    "description": "Sweeping historical novels, wartime stories and richly imagined sagas set against the past.",
    "tags": [
  ...
  "books-film-tv": {
    ...
    "description": "Books that made the leap from page to film or television, and the stories behind them.",
    "tags": [
