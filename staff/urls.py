...
# Add-book wizard and manual add-book form associated paths
urlpatterns = [
...
# Debug/helper endpoint for staff-only Google Books API probing.
# Keep for now - can be disabled later if no longer needed
urlpatterns += [
