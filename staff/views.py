...
from .forms import StaffBookLookupForm, BookDraftForm, AddBookQuickForm

from .helpers import save_temp_uploaded_file, format_author_name, format_book_title
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            try:
                ...
                return render(request, 'staff/book_add_old.html', {'form': form})
